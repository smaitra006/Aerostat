...
function IndexTooltip({ active, payload }: CustomTooltipProps) {
  ...
  return (
    <div className="bg-[#141418] border border-[#2F2F38] px-3.5 py-2.5 rounded shadow-xl font-mono text-xs text-white space-y-1 z-50 relative">
    ...
    <div className="w-full h-full p-4 sm:p-5 font-mono text-xs space-y-4 flex flex-col">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-white/5">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-[10px] px-2 py-0.5 rounded font-semibold uppercase tracking-wider flex items-center gap-1.5">
        ...
        <div className="flex flex-wrap items-center gap-2 text-[11px]">
          <div className="bg-zinc-900/60 border border-white/5 px-2.5 py-1 rounded flex items-center gap-1.5">
          ...
          <div className="bg-zinc-900/60 border border-white/5 px-2.5 py-1 rounded flex items-center gap-1.5 text-zinc-400">
            <span>Range:</span>
      ...
      {/* FOOTER NOTE */}
      <div className="flex items-center gap-2 pt-2 border-t border-white/5 text-[10px] text-zinc-500 mt-auto">
